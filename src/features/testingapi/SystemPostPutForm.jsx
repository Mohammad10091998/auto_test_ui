...
import { systemPostPutSchema } from "./schemas";

export default function SystemPostPutForm() {
  ...
  const {
    ...
    validationSchema: systemPostPutSchema,
              ...
              <div className="border border-slate-300 mt-3 w-full p-1">
                <div className="w-full px-3">
                  <textarea
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className="h-96 p-2 my-1 block w-full rounded-md border shadow-sm focus:border-slate-300 focus:ring focus:ring-slate-200 focus:ring-opacity-50"
                    placeholder="payload"
                    name="payload"
                    id="payload"
                    spellCheck="false"
